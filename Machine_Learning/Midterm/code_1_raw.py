...
#Plot the distributions of the input data.
df = df[['X2 house age', 'X3 distance to the nearest MRT station', 'X4 number of convenience stores','X5 latitude', 'X6 longitude' ]]
df.hist(bins=5,figsize=(16,9),grid=False);
